...
public class FinalVertexPulse extends VertexPulse {
	...
	public void pulse(int PCost, int PMean, int PVar, double Alfa,
		...
		// Add node id to path
		path.add(id);
		double TTB = NormalDistQuick.inverseF(PMean, PVar, Alfa);
		// If the path is feasible and updates the primal bound the information
		// on the best solution found is updated
